      ...
      <div className="container">
        ...
        <div className={`collapse navbar-collapse ${isExpanded ? 'show' : ''}`} id="navbarNav">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link href="/3d-model/data" className={`nav-link ${pathname === '/3d-model/data' ? 'active' : ''}`}>
                3D Model (Data)
              </Link>
            </li>
            <li className="nav-item">
              <Link href="/3d-model/eclss" className={`nav-link ${pathname === '/3d-model/eclss' ? 'active' : ''}`}>
                ECLSS
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link href="/ml-model" className={`nav-link ${pathname === '/ml-model' ? 'active' : ''}`}>
                ML Model
              </Link>
            </li>
            {/*
