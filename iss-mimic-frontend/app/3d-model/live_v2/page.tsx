        ...
        <div style={{ height: '100vh', width: '100vw' }}>
            <Canvas>
                ...
                <mesh>
                    ...
                    <SolarPanel2 
                        position={[2, 0, 0]} 
                        rotation={[telemetrySARJ2?.value ? Number(telemetrySARJ2.value)*(Math.PI/180) : 0, 0, telemetryBGA7?.value ? Number(telemetryBGA7.value)*(Math.PI/180) : 0]} 
                        color="green"
                    />
                    ...
                    <SolarPanel2 
                        position={[4.5, 0, 0]} 
                        rotation={[telemetrySARJ2?.value ? Number(telemetrySARJ2.value)*(Math.PI/180) : 0, 0, telemetryBGA5?.value ? Number(telemetryBGA5.value)*(Math.PI/180) : 0]} 
                        color="purple"
                    />
                    ...
                    <SolarPanel2 
                        position={[-2, 0, 0]} 
                        rotation={[telemetrySARJ1?.value ? Number(telemetrySARJ1.value)*(Math.PI/180) : 0, 0, telemetryBGA3?.value ? Number(telemetryBGA3.value)*(Math.PI/180) : 0]} 
                        color="orange" 
                    />
                    ...
                    <SolarPanel2 
                        position={[-4.5, 0, 0]} 
                        rotation={[telemetrySARJ1?.value ? Number(telemetrySARJ1.value)*(Math.PI/180) : 0, 0, telemetryBGA1?.value ? Number(telemetryBGA1.value)*(Math.PI/180) : 0]} 
                        color="red"
                    />
                </mesh> 
                <OrbitControls />
